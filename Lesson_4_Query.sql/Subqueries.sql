...
2.) Use the result of the previous query to find only the orders that took place in the same month and year as the first order then pull the average for each type of paper qty in this month. 
